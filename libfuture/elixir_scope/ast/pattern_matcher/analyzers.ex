...
defmodule ElixirScope.AST.PatternMatcher.Analyzers do
  ...
  def analyze_ast_patterns(functions, %Types{} = spec) do
    matches =
      Enum.flat_map(functions, fn function_data ->
  ...
  @spec analyze_behavioral_patterns(list(), map(), Types.pattern_spec()) ::
          {:ok, list(Types.pattern_match())}
  ...
  @spec analyze_anti_patterns(list(), map(), Types.pattern_spec()) ::
          {:ok, list(Types.pattern_match())}
