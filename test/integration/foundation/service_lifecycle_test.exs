defmodule ElixirScope.Foundation.Integration.ServiceLifecycleTest do
  ...
  #     initial_pid = Process.whereis(ElixirScope.Foundation.ConfigServer)
  ...
  #     new_pid = Process.whereis(ElixirScope.Foundation.ConfigServer)
  ...
  #     initial_pid = Process.whereis(ElixirScope.Foundation.EventStore)
  #     assert is_pid(initial_pid)
  ...
  #     new_pid = Process.whereis(ElixirScope.Foundation.EventStore)
  #     assert is_pid(new_pid)
  #     assert new_pid != initial_pid
  ...
  #     initial_pid = Process.whereis(ElixirScope.Foundation.TelemetryService)
  #     assert is_pid(initial_pid)
  ...
  #     new_pid = Process.whereis(ElixirScope.Foundation.TelemetryService)
  #     assert is_pid(new_pid)
  #     assert new_pid != initial_pid
  ...
  #     config_pid = Process.whereis(ElixirScope.Foundation.ConfigServer)
  ...
  #     # Kill EventStore
  #     event_store_pid = Process.whereis(ElixirScope.Foundation.EventStore)
  ...
  #     telemetry_pid = Process.whereis(ElixirScope.Foundation.TelemetryService)
  ...
  #     task = Task.Supervisor.async(ElixirScope.Foundation.TaskSupervisor, task_fun)
  ...
  #     # Run failing task
  #     task = Task.Supervisor.async(ElixirScope.Foundation.TaskSupervisor, failing_task_fun)
  ...
  #     success_task = Task.Supervisor.async(ElixirScope.Foundation.TaskSupervisor, fn ->
  #       {:ok, "success"}
  #     end)
  ...
  #     tasks = for i <- 1..10 do
  #       Task.Supervisor.async(ElixirScope.Foundation.TaskSupervisor, fn ->
  ...
  #     assert Process.whereis(ElixirScope.Foundation.EventStore) == event_store_pid
  #     assert Process.whereis(ElixirScope.Foundation.TelemetryService) == telemetry_pid
  ...
  #     new_config_pid = Process.whereis(ElixirScope.Foundation.ConfigServer)
