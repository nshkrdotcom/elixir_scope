defmodule ElixirScope.Foundation.Infrastructure.IntegrationTest do
  @moduledoc """
  ...
  describe "CircuitBreaker integration" do
    test "circuit breaker with configuration" do
      ...
      assert {:error, %ElixirScope.Foundation.Types.Error{error_type: :protected_operation_failed}} =
               CircuitBreaker.execute(breaker_name, fn ->
                 raise "test_error"
               end)
