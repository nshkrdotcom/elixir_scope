defmodule ElixirScope.Foundation.Infrastructure.ConnectionManagerTest do
  @moduledoc """
  ...
  alias ElixirScope.Foundation.Infrastructure.ConnectionManager
  ...
  defp setup_test_pool(context \\ %{}) do
    ...
    manager_pid = Process.whereis(ElixirScope.Foundation.Infrastructure.ConnectionManager)
  ...
  describe "telemetry integration" do
    setup do
      ...
      :telemetry.attach_many(
        ...
        [
          ...
          [:elixir_scope, :foundation, :connection_pool, :pool_started],
          [:elixir_scope, :foundation, :connection_pool, :pool_stopped]
        ],
    ...
    test "emits checkout and checkin events", %{pool_name: pool_name, telemetry_ref: ref} do
      ...
      assert_receive {^ref, :telemetry, [:elixir_scope, :foundation, :connection_pool, :checkout],
      ...
      assert_receive {^ref, :telemetry, [:elixir_scope, :foundation, :connection_pool, :checkin],
    ...
    test "emits pool lifecycle events", %{pool_name: pool_name, telemetry_ref: ref} do
      ...
      assert_receive {^ref, :telemetry,
                      [:elixir_scope, :foundation, :connection_pool, :pool_started], _measurements,
                      metadata},
                     1000
      ...
      assert_receive {^ref, :telemetry,
                      [:elixir_scope, :foundation, :connection_pool, :pool_stopped], _measurements,
                      metadata},
                     1000
  ...
  describe "error scenarios and recovery" do
    ...
    test "recovers from pool supervisor restarts" do
      ...
      assert Process.alive?(
               Process.whereis(ElixirScope.Foundation.Infrastructure.ConnectionManager)
             )
