...
#   alias ElixirScope.Foundation.Types.{Config, Error}
#   alias ElixirScope.Foundation.{Events, Telemetry}
...
#       {:ok, _} = GenServer.start_link(ElixirScope.Foundation.Services.EventStore, [], name: ElixirScope.Foundation.EventStore)
#       {:ok, _} = GenServer.start_link(ElixirScope.Foundation.Services.TelemetryService, [], name: ElixirScope.Foundation.TelemetryService)
...
#     test "emit_config_event correctly uses ElixirScope.Foundation.Events.new_event/2" do
