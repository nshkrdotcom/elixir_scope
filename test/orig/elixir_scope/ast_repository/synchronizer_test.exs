defmodule ElixirScope.ASTRepository.SynchronizerTest do
  ...
  describe "File synchronization" do
    ...
    test "synchronizes new file creation", %{
      repository: repo,
      synchronizer: sync,
      sync_dir: sync_dir
    } do
    ...
    test "synchronizes file modifications", %{
      repository: repo,
      synchronizer: sync,
      sync_dir: sync_dir
    } do
  ...
  describe "Batch synchronization" do
    ...
    test "synchronizes multiple files efficiently", %{
      repository: repo,
      synchronizer: sync,
      sync_dir: sync_dir
    } do
    ...
    test "handles mixed valid and invalid files in batch", %{
      repository: repo,
      synchronizer: sync,
      sync_dir: sync_dir
    } do
  ...
  describe "Performance and reliability" do
    ...
    test "memory usage remains stable during long operation", %{
      synchronizer: sync,
      sync_dir: sync_dir
    } do
