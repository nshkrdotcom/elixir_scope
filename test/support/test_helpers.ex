defmodule ElixirScope.TestHelpers do
  ...
  alias ElixirScope.Foundation.{Config, Events, Utils, Error, ErrorContext}
...
# defmodule ElixirScope.Test.FoundationHelpers do
#   @moduledoc """
...
#   alias ElixirScope.Foundation.{Config, Events, Types, Utils}

#   @doc """
#   Initialize Foundation layer with test configuration.
#   """
#   def initialize_foundation(opts \\ []) do
#     Application.put_env(:elixir_scope, :dev, %{debug_mode: true})
#     ElixirScope.Foundation.initialize(opts)
#   end
...
#     Application.delete_env(:elixir_scope, :dev)
#     :ok
#   end
...
#     tmp_dir = Path.join(System.tmp_dir!(), "elixir_scope_test_#{Utils.generate_id()}")
