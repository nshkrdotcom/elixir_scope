defmodule ElixirScope.Foundation.Utils do
  ...
  ## Examples
      ...
      iex> id1 = ElixirScope.Foundation.Utils.generate_id()
      iex> id2 = ElixirScope.Foundation.Utils.generate_id()
      iex> id1 != id2
      true
  """
  ...
  ## Examples
      ...
      iex> timestamp = ElixirScope.Foundation.Utils.monotonic_timestamp()
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Utils.truncate_if_large(small_data)
      [1, 2, 3]

      iex> large_data = String.duplicate("x", 100_000)
      iex> result = ElixirScope.Foundation.Utils.truncate_if_large(large_data)
  ...
  ## Examples
      ...
      iex> small_data = [1, 2, 3]
      iex> ElixirScope.Foundation.Utils.truncate_if_large(small_data, 1000)
      [1, 2, 3]

      iex> large_data = String.duplicate("x", 2000)
      iex> result = ElixirScope.Foundation.Utils.truncate_if_large(large_data, 1000)
      iex> is_map(result) and Map.has_key?(result, :truncated)
      true
  """
  ...
  ## Examples
      ...
      iex> size = ElixirScope.Foundation.Utils.deep_size(%{a: 1, b: [1, 2, 3]})
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Utils.safe_inspect(%{key: "value"})
      "%{key: \"value\"}"

      iex> ElixirScope.Foundation.Utils.safe_inspect(:atom)
      ":atom"
  """
  ...
  ## Examples
      ...
      iex> map1 = %{a: %{b: 1}, c: 2}
      iex> map2 = %{a: %{d: 3}, e: 4}
      iex> ElixirScope.Foundation.Utils.deep_merge(map1, map2)
      %{a: %{b: 1, d: 3}, c: 2, e: 4}
  """
  ...
  ## Examples
      ...
      iex> data = %{a: %{b: %{c: 42}}}
      iex> ElixirScope.Foundation.Utils.get_nested(data, [:a, :b, :c], 0)
      42

      iex> ElixirScope.Foundation.Utils.get_nested(data, [:x, :y], "default")
      "default"
  """
  ...
  ## Examples
      ...
      iex> data = %{}
      iex> ElixirScope.Foundation.Utils.put_nested(data, [:a, :b, :c], 42)
      %{a: %{b: %{c: 42}}}
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Utils.sanitize_string("hello\\nworld\\ttab")
      "hello world tab"
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Utils.atomize_keys(data)
      %{key: %{nested: "value"}}
  """
  ...
  ## Examples
      ...
      iex> data = %{key: %{nested: "value"}}
      iex> ElixirScope.Foundation.Utils.stringify_keys(data)
      %{"key" => %{"nested" => "value"}}
  """
  ...
  ## Examples
      ...
      iex> result = ElixirScope.Foundation.Utils.retry(fn -> :ok end, max_attempts: 3)
      {:ok, :ok}
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Utils.blank?(nil)
      true

      iex> ElixirScope.Foundation.Utils.blank?("")
      true

      iex> ElixirScope.Foundation.Utils.blank?("hello")
      false
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Utils.present?("hello")
      true

      iex> ElixirScope.Foundation.Utils.present?(nil)
      false
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Utils.format_duration(1_500_000_000)
      "1.5s"

      iex> ElixirScope.Foundation.Utils.format_duration(2_500_000)
      "2.5ms"
  """
  ...
  ## Examples
      ...
      iex> timestamp = ElixirScope.Foundation.Utils.wall_timestamp()
      iex> is_integer(timestamp)
      true
  """
