defmodule ElixirScope.Foundation.Infrastructure.ConnectionManager do
  @moduledoc """
  ...
  - `[:elixir_scope, :foundation, :connection_pool, :checkout]` - Connection checked out
  - `[:elixir_scope, :foundation, :connection_pool, :checkin]` - Connection returned
  - `[:elixir_scope, :foundation, :connection_pool, :timeout]` - Checkout timeout
  - `[:elixir_scope, :foundation, :connection_pool, :overflow]` - Pool overflow occurred
  """
  ...
  defp emit_telemetry(event, measurements, metadata) do
    TelemetryService.execute(
      [:elixir_scope, :foundation, :connection_pool, event],
      measurements,
      metadata
    )
  end
