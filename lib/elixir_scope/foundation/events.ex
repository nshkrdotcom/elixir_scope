defmodule ElixirScope.Foundation.Events do
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.initialize()
      :ok
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.status()
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.new_event(:test_event, %{key: "value"})
      {:ok, %Event{event_type: :test_event, data: %{key: "value"}}}

      iex> ElixirScope.Foundation.Events.new_event(:invalid, nil)
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.debug_new_event(:test_event, %{key: "value"})
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.serialize(event)
      {:ok, <<...>>}
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.deserialize(serialized)
      {:ok, %Event{...}}
  """
  ...
  ## Examples
      ...
      iex> {:ok, event} = Events.new_event(:test, %{})
      iex> ElixirScope.Foundation.Events.serialized_size(event)
      {:ok, 156}
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.store(event)
      {:ok, 12345}
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.store_batch(events)
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.get(12345)
      {:ok, %Event{event_id: 12345, ...}}

      iex> ElixirScope.Foundation.Events.get(99999)
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.query(query)
      {:ok, [%Event{}, ...]}
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.get_by_correlation("req-123")
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.prune_before(cutoff)
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.stats()
      {:ok, %{
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.get_correlation_chain("req-123")
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.get_time_range(start_time, end_time)
      {:ok, [%Event{}, ...]}
  """
  ...
  ## Examples
      ...
      iex> ElixirScope.Foundation.Events.get_recent(50)
